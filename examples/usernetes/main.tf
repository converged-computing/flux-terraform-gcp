...
module "cluster" {
  source = "github.com/researchapps/scientific-computing-examples.git//fluxfw-gcp/tf?ref=expose-login"
  ...
  # This is only here to skip an error we don't have the default
  compute_arm_family = var.compute_family
